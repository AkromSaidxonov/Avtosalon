...
import { useAddCarsMutation } from "../redux/queries/cars";


function AddCars({ cars, handleCloseCars, marka }) {
  const [addCars, { isError }] = useAddCarsMutation();
  ...
  const handleAddCar = async (e) => {
    e.preventDefault();
    await addCars(carData);
    console.log(carData);
    toast.success("Yangi mashina qo`shildi");
    handleCloseCars(false);
    e.target.reset();
  };
